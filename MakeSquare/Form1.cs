    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            try
            {
                ...
                algorthim algo = new algorthim(Noshape);
                ...
                for (int i = 0; i < Noshape; i++)
                {
                    allshape[i] = move.generatePiece(allshape[i]);
                }
                ...
                foreach (Result item in res)
                {
                    ...
                    for (int i = 0; i < Noshape; i++)
                    {
                        shapeState[i] = item.shape[i].value.ToString() + " = " + item.shape[i].state;
                    }
                    stateArray.Add(shapeState);
                }

                foreach (Result x in myarray)
                {
                    for (int i = 0; i < Noshape; i++)
                    {
                ...
                else
                {
                    ...
                    thanks.Text = "( " + res.Count().ToString() + " )   Shape ";
            ...
            var space = new Label();
            space.Text = "    ";
            space.SetBounds(230, y+10, 50, 30);
